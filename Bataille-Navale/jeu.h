...
/*	Pre-conditions 	: j adresse d'un jeu
	...
	Valeur retour : adresse du joueur
*/
joueur* jeu_get_joueur(jeu* j);
...
/*	Pre-conditions 	: j adresse d'un jeu
	Post-conditions : aucune
	Valeur retour : nombre de parties gagnees dans le partage en cours
*/
int jeu_get_nb_parties_gagnees(jeu* j);

/*	Pre-conditions 	: j adresse d'un jeu
	Post-conditions : aucune
	Valeur retour : nombre de parties perdues dans le partage en cours
*/
int jeu_get_nb_parties_perdues(jeu* j);
...
/*	Pre-conditions 	: j adresse d'un jeu
	Post-conditions : aucune
	Valeur retour : adresse d'un type structuré client
*/
client* jeu_get_client(jeu* j);

/*	Pre-conditions 	: j adresse d'un jeu
	Post-conditions : aucune
	Valeur retour : adresse d'un type structuré serveur
*/
serveur* jeu_get_serveur(jeu* j);
...
/*	Pre-conditions 	: j adresse d'un jeu (partage : contrainte fonctionnelle et non technique) dont le joueur est instancie
	Post-conditions : nombre de parties gagnees par le joueur mis a jour
*/
void jeu_set_nb_parties_gagnees(jeu* j, int n);
...
/*	Pre-conditions 	: j adresse d'un jeu non partage et non en attente d'etre rejoint (j->statut_joueur = JEU_JOUEUR_STATUT_INDETERMINE, j->etat == JEU_ETAT_NONE),
	...
	Gestion erreur	: en cas d'erreur survenue, deconnexion & suppression socket client (le statut du joueur et l'état de la partie sont alors inchangés)
*/
int jeu_rejoindre_partie_par_nom_hote(jeu* j, const char nom_hote[NOM_HOTE_TAILLE_MAX +1]);
...
/*	Pre-conditions 	: j adresse d'un jeu non partage et non en attente d'etre rejoint (j->statut_joueur = JEU_JOUEUR_STATUT_INDETERMINE, j->etat == JEU_ETAT_NONE),
	...
	Gestion erreur	: en cas d'erreur survenue, deconnexion & suppression socket client (le statut du joueur et l'état de la partie sont alors inchangés)
*/
int jeu_rejoindre_partie_par_ip(jeu* j, const char ip[IP_TAILLE_MAX +1]);
